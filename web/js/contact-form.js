	...
	$("a#submit").click(function(){
		...
		$.ajax({
			...
			success: function(){
				$('.error').fadeOut(0);
				$('form#contact-form').clearForm();
				$('#contact_form').html("<div class='download-box'>Uw boodschap is verstuurd.</div>")
					.append("<br><label for='message'><b>U wordt zsm bantwoord.</b></label>")
					.hide()
					.fadeIn(1500, function(){
						$('#contact_form').append("<br><br><a id='back' onclick='window.location.reload(); return false;' class='link10'>back</a>");
					});
			}
		});				
		return false;
